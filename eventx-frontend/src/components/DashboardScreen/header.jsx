    ...
    return(
        <header>
            <div className="w-full h-[91px] bg-[#111111] mt-[5px] rounded-[20px] flex items-center justify-between">
                <div className="flex items-center ml-[32px] gap-[10px]"><div><img src={image} alt="" className="rounded-full"/></div><div className="text-white"><h1 className="text-[30px]">Welcome {user.name}</h1><h6 className="text-[10px]"> {user.role}</h6></div></div>
